...
myapp.service('dboticaServices', ['$http', '$state', '$log', '$q', function($http, $state, $log, $q) {
    ...
    this.login = function(userEmailId, password) {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/login',
            headers: {
    ...
    this.doctorsOfAssistant = function() {
        ...
        var requestEntity = {
            method: "GET",
            url: "https://dbotica.com:8443/dbotica-spring/assistant/getMyDoctors",
            withCredentials: true
        }
    ...
    this.getPatientsListOfDoctor = function(doctorId) {
        ...
        var req = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/getDoctorEvents?doctorId=' + doctorId,
            withCredentials: true
        }
        $http(req).then(function(response) {
            deferred.resolve(response);
    ...
    this.getCaseHistory = function(patientId) {
        ...
        var caseRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getCaseHistory?patientId=' + patientId,
            withCredentials: true
        }
    ...
    this.getPatientDetailsOfThatNumber = function(phoneNumberForSearch) {
        ...
        var req = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/getPatients?patientIds=' + phoneNumberForSearch,
            withCredentials: true
        }
        $http(req).then(function(response) {
            deferred.resolve(response);
    ...
    this.futureAppointmentListOfNumber = function(patientPhoneNumberForCancelling, doctorId) {
        ...
        var req = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/getDoctorEvents?patientPhoneNumber=' + patientPhoneNumberForCancelling + '&doctorId=' + doctorId + '&fetchAllEvents=true',
            withCredentials: true
        }
        $http(req).then(function(response) {
            deferred.resolve(response);
    ...
    this.cancelAppointmentOfADateOrUpdateDoctorEvent = function(cancelBook) {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/updateCalendarEvent',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.updateDoctorTimings = function(addTimeObj) {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/updateDoctorTimings',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getDoctorEventsOfDocOnADate = function(doctorId, milliSecsOfDate) {
        ...
        var req = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/getDoctorEvents?doctorId=' + doctorId + '&requestTime=' + milliSecsOfDate,
            withCredentials: true
    ...
    this.getDrugsFromDb = function(start, limit, brandName) {
        ...
        var requestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/drug/getDrugs?start=' + start + '&limit=' + limit + '&brandName=' + brandName,
            withCredentials: true
        }
    ...
    this.addNewPatient = function(newPatientDetails) {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/addPatient',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.logout = function() {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/logout',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.addItemIntoStock = function(object) {
        ...
        var requestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/addItem',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getItemsOfTheTable = function(start, limit, stockType, itemType, organizationId) {
        ...
        if (itemType == "All") {
            switch (stockType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId });
                    break;
                case 'Low':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "lowStock": true });
                    break;
                case 'Expired':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "expired": true });
                    break;
            }
        ...
        if (itemType == "Drug") {
            switch (stockType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "inventoryItemType": "DRUG" });
                    break;
                case 'Low':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "lowStock": true, "inventoryItemType": "DRUG" });
                    break;
                case 'Expired':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "expired": true, "inventoryItemType": "DRUG" });
                    break;
            }
        ...
        if (itemType == "Supplies") {
            switch (stockType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "inventoryItemType": "SUPPLIES" });
                    break;
                case 'Low':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "lowStock": true, "inventoryItemType": "SUPPLIES" });
                    break;
                case 'Expired':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "expired": true, "inventoryItemType": "SUPPLIES" });
                    break;
            }
        ...
        if (itemType == "Equipments") {
            switch (stockType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "inventoryItemType": "EQUIPMENT" });
                    break;
                case 'Low':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "lowStock": true, "inventoryItemType": "EQUIPMENT" });
                    break;
                case 'Expired':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "expired": true, "inventoryItemType": "EQUIPMENT" });
                    break;
            }
        }
        if (itemType == "Others") {
            switch (stockType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "inventoryItemType": "OTHERS" });
                    break;
                case 'Low':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "lowStock": true, "inventoryItemType": "OTHERS" });
                    break;
                case 'Expired':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "start": start, "limit": limit, "organizationId": organizationId, "expired": true, "inventoryItemType": "OTHERS" });
                    break;
            }
        }
        var requestEntity = {
    ...
    this.addBatchToTheDrug = function(requestEntity) {
        ...
        var req = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/addBatch',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getAllBatches = function(itemId, organizationId) {
        ...
        var requestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/getItemDetails?itemId=' + itemId + '&organizationId=' + organizationId,
            withCredentials: true
        }
        $http(requestEntity).then(function(response) {
            deferred.resolve(response);
    ...
    this.getItemFromDB = function(itemName, organizationId) {
        ...
        var requestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "itemName": itemName, "organizationId": organizationId }),
            withCredentials: true,
        }
        $http(requestEntity).then(function(response) {
            deferred.resolve(response);
    ...
    this.getItemFromDBWithId = function(itemId, organizationId) {
        ...
        var requestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "itemId": itemId, "organizationId": organizationId }),
            withCredentials: true,
        }
    ...
    this.updateTheBatch = function(req) {
        ...
        var requestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/inventory/updateBatchCount',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.lowStockExpiredStockItems = function(lowOrExpired, start, limit, itemType, organizationId) {
        ...
        if (lowOrExpired == "lowItems") {
            ...
            switch (itemType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "lowStock": true, "start": start, "limit": limit, "organizationId": organizationId });
                    break;
                case 'Drug':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "lowStock": true, "start": start, "limit": limit, "inventoryItemType": "DRUG", "organizationId": organizationId });
                    break;
                case 'Supplies':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "lowStock": true, "start": start, "limit": limit, "inventoryItemType": "SUPPLIES", "organizationId": organizationId });
                    break;
                case 'Equipments':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "lowStock": true, "start": start, "limit": limit, "inventoryItemType": "EQUIPMENT", "organizationId": organizationId });
                    break;
                case 'Others':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "lowStock": true, "start": start, "limit": limit, "inventoryItemType": "OTHERS", "organizationId": organizationId });
                    break;
            }
            requestEntity = {
                method: 'GET',
            ...
            switch (itemType) {
                case 'All':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "expired": true, "start": start, "limit": limit, "organizationId": organizationId });
                    break;
                case 'Drug':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "expired": true, "start": start, "limit": limit, "inventoryItemType": "DRUG", "organizationId": organizationId });
                    break;
                case 'Supplies':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "expired": true, "start": start, "limit": limit, "inventoryItemType": "SUPPLIES", "organizationId": organizationId });
                    break;
                case 'Equipments':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "expired": true, "start": start, "limit": limit, "inventoryItemType": "EQUIPMENT", "organizationId": organizationId });
                    break;
                case 'Others':
                    localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "expired": true, "start": start, "limit": limit, "inventoryItemType": "OTHERS", "organizationId": organizationId });
                    break;
            }
            requestEntity = {
                method: 'GET',
    ...
    this.getStockItemsForTheTable = function(type, start, limit, stockType, organizationId) {
        ...
        switch (type) {
            ...
            case 'DrugItems':
                switch (stockType) {
                    case 'All':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "DRUG", "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Low':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "DRUG", "lowStock": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Expired':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "DRUG", "expired": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                }
                break;
            case 'EquipmentItems':
                switch (stockType) {
                    case 'All':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "EQUIPMENT", "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Low':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "EQUIPMENT", "lowStock": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Expired':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "EQUIPMENT", "expired": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                }
                break;
            case 'SuppliesItems':
                switch (stockType) {
                    case 'All':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "SUPPLIES", "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Low':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "SUPPLIES", "lowStock": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Expired':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "SUPPLIES", "expired": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                }
                break;
            case 'OtherItems':
                switch (stockType) {
                    case 'All':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "OTHERS", "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Low':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "OTHERS", "lowStock": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                    case 'Expired':
                        localUrl = 'https://dbotica.com:8443/dbotica-spring/inventory/getItems?queryString=' + JSON.stringify({ "inventoryItemType": "OTHERS", "expired": true, "start": start, "limit": limit, "organizationId": organizationId });
                        break;
                }
                break;
        }
    ...
    this.submitServiceRequest = function(serviceRequestEntity) {
        ...
        var serviceRequestIs = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/updateDoctorPrices',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.submitTestRequest = function(testObject) {
        ...
        var testRequest = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/updateTest',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getTestsByAdmin = function() {
        ...
        var getTestsRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/getTests',
            withCredentials: true
        }
    ...
    this.updateInvoice = function(invoice) {
        ...
        var invoiceRequest = {
            method: 'POST',
            url: ' https://dbotica.com:8443/dbotica-spring/organization/billing/updateInvoice',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getInvoiceHistoryOnLoad = function(organizationId) {
        ...
        var invoiceHistoryRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'organizationId': organizationId }),
            withCredentials: true
        }
    ...
    this.getInvoicesWithCaseId = function(caseId) {
        ...
        var caseRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'organizationCaseId': caseId }),
            withCredentials: true
        }
        $http(caseRequest).then(function(caseSuccess) {
            deferred.resolve(caseSuccess);
    ...
    this.searchResultOfInvoice = function(organizationId, searchType, firstSearchEntity, secondSearchEntity) {
        ...
        switch (searchType) {
            case 'Phone Number':
                localUrl = 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'patientPhoneNumber': firstSearchEntity, "organizationId": organizationId });
                break;
            case 'Bill Number':
                localUrl = 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'invoiceId': firstSearchEntity, "organizationId": organizationId });
                break;
            case 'Date':
                ...
                localUrl = 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'startTime': longValueOfStartDate, 'endTime': longValueOfEndDate, "organizationId": organizationId });
                break;
            case 'Next Due Date':
                var longValueOfDate = this.getLongValueOfDate(firstSearchEntity);
                localUrl = 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'nextPaymentDueDate': longValueOfDate, "organizationId": organizationId });
                break;
            case 'Doctor':
                localUrl = 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'doctorId': firstSearchEntity, "organizationId": organizationId });
                break;
        }
    ...
    this.getPendingInvoices = function(organizationId) {
        ...
        var getPendingRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/billing/getInvoices?queryString=' + JSON.stringify({ 'organizationId': organizationId, 'paymentPending': true }),
            withCredentials: true
        }
    ...
    this.getPrescriptionsOfThePatient = function(patientId) {
        ...
        var getPrescriptionRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/patient/getPrescriptions?patientId=' + patientId + '&start=' + start + '&limit=' + limit,
            withCredentials: true
        }
    ...
    this.addOrUpdateRoomCategory = function(roomCategoryObject) {
        ...
        var roomCategoryEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updateRoomCategory',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getRoomCategories = function(organizationId) {
        ...
        var getRoomCategoriesEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getRoomCategories?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.addOrUpdateRoom = function(newRoomObject) {
        ...
        var newRoomEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updateRoom',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getRooms = function(organizationId) {
        ...
        var getRoomsEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getRooms?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.addNewDoctorCategory = function(newDoctorCategoryObject) {
        ...
        var addNewDoctorCategoryEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updateDoctorCategory',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getDoctorCategories = function(organizationId) {
        ...
        var getDoctorCategoriesEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getDoctorCategories?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.addNewDoctorToACategory = function(addDoctorToACategoryObject) {
        ...
        var addNewDoctorRequestentity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updateDoctor',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.doctorsListInMainAdmin = function(organizationId) {
        ...
        var getDoctorListInMainAdminEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getDoctors?organizationId=' + organizationId + '&doctorType=' + '',
            withCredentials: true
        }
    ...
    this.addNewBed = function(addNewBedRequest) {
        ...
        var addNewBedRequestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updateBed',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getBeds = function(organizationId) {
        ...
        var getBedsRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getBeds?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.registerPatient = function(registerPatientEntityFromController) {
        ...
        var registPatientEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updatePatient',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.newDoctorByAssistant = function(newDoctor) {
        ...
        var newDoctorEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/addDoctor',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getOrganizationAddress = function() {
        ...
        var addressEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/getAddress',
            withCredentials: true,
        }
    ...
    this.getRegisteredPatients = function(organizationId) {
        ...
        var registeredPatientsRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getPatients?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.updateOrgAddress = function(updateAddress) {
        ...
        var updateEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/updateAddress',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.patientEvent = function(patientEventToBeUpdated) {
        ...
        var patientEventRequestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/updatePatientEvent',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getPatientEvents = function(organizationId) {
        ...
        var getEventsRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getPatientEvents?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.getPatientEventsWithPatientId = function(organizationId, patientId) {
        ...
        var getEventsRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getPatientEvents?organizationId=' + organizationId + '&patientIds=' + patientId,
            withCredentials: true
        }
    ...
    this.addPatientToBed = function(addPatientBedObject) {
        ...
        var addPatientRequestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/addPatientToBed',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getInPatientsWithPhoneNumber = function(phoneNumber) {
        ...
        var getInPatientsRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getOrgPatientByPhone?phoneNumber=' + phoneNumber,
            withCredentials: true
        }
    ...
    this.transferPatientToAnotherRoom = function(transferPatientObject) {
        ...
        var transferEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/transferPatient',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.addPrescription = function(prescription) {
        ...
        var prescriptionEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/assistant/updatePrescription',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getTransferPatients = function(organizationId) {
        ...
        var getTransferEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getTransferEvents?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.getOrganizationAssistants = function(organizationId) {
        ...
        var getAssistantsRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/getAssistantsByOrganizationId?organizationId=' + organizationId,
            withCredentials: true
        }
    ...
    this.assistantAddition = function(assistantToAdd) {
        ...
        var addAssistantRequest = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/addAssistant',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getTests = function(test) {
        ...
        var getTestRequestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/diagnosis/getDiagnosisTest?diagnosisTest=' + test,
            withCredentials: true
        }
    ...
    this.getLabEntities = function() {
        ...
        labEntityRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/getLabEvents',
            withCredentials: true
        }
    ...
    this.getPrescriptionsOfCase = function(caseId) {
        ...
        var caseRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getPrescriptionsByCase?organizationCaseId=' + caseId,
            withCredentials: true
        }
        $http(caseRequest).then(function(caseSuccess) {
            deferred.resolve(caseSuccess);
    ...
    this.getPatientAndOrganizationPatient = function(phoneNumber) {
        ...
        var requestEntity = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getPatientAndOrganizationPatient?phoneNumber=' + phoneNumber,
            withCredentials: true
        }
    ...
    this.updateLabEvent = function(labEvent) {
        ...
        var labRequestEntity = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/updateLabEvent',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getOrganizationPatient = function(patientId) {
        ...
        var getOrganizationRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/getOrgPatientByPatientId?patientId=' + patientId,
            withCredentials: true
        }
    ...
    this.registerPatientInsurance = function(insuranceRequest) {
        ...
        var fieldRequest = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/billing/updatePatientInsurance',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.addFieldRequest = function(addFieldRequestEntity) {
        ...
        var fieldRequest = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/template/addTemplate',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
    ...
    this.getAllTemplates = function(organizationId, template, visibility) {
        ...
        var getTemplatesRequest = {
            method: 'GET',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/template/getTemplates?organizationId=' + organizationId + '&name=' + template + '&showInvisible=' + visibility,
            withCredentials: true
        }
    ...
    this.addTemplateInstance = function(templateInstance) {
        ...
        var instanceRequest = {
            method: 'POST',
            url: 'https://dbotica.com:8443/dbotica-spring/organization/hospital/template/addTemplateInstance',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
